...
import dtos.DtoAuthRespuesta;
import dtos.DtoLogin;
import dtos.DtoRegistro;
import repositories.IRolesRepository;
...
public class RestControllerAuth {
    ...
    @Autowired
    public RestControllerAuth(AuthenticationManager authenticationManager, PasswordEncoder passwordEncoder, IRolesRepository rolesRepository, IUsersRepository usuariosRepository, JwtGenerator jwtGenerador) {
